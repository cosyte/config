...
/**
 * The install-hardening settings file the shipped manifest asks for, WRITTEN FROM THE MANIFEST'S OWN
 * NUMBERS. Copying the floor into this fixture would make a rule that had been tightened in the
 * standard read as a fixture that is out of date.
 */
...
function umbrellaWithConfig(files: Record<string, string> = {}): string {
  ...
  const contents: Record<string, string> = {
    ...
    // and not package.json, so a fixture without one reports a drift about the fixture.
