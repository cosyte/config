...
/** The install-hardening settings file the shipped manifest asks for, written from its own numbers. */
function hardeningSettings(): string {
...
function umbrellaWithConfig(files: Record<string, string> = {}): string {
  ...
  const contents: Record<string, string> = {
    ...
    // The subject is held to the package baseline's install-hardening rule, which reads this file
    // rather than package.json. Its numbers come from the manifest, so a floor that moves there
    // moves here and this fixture cannot go stale against the standard it is meant to satisfy.
    "pnpm-workspace.yaml": hardeningSettings(),
    "pnpm-lock.yaml":
      "lockfileVersion: '9.0'\n\npackages:\n\n  js-yaml@3.15.1: {}\n\n  js-yaml@4.3.1: {}\n\n  esbuild@0.28.1: {}\n",
